...
public class HQLStatementUtil {
    public static final String HQL_SELECT_ALL_SUPPLIERS = "From Suppliers";
    public static final String HQL_SELECT_SUPPLIERS_BY_ID = "FROM Suppliers as s where s.id = :id";
    public static final String HQL_SELECT_SUPPLIER_WITH_USERS_BY_SUPPLIER_ID = "SELECT distinct s FROM Suppliers as s " +
            "left join fetch s.usersSet as users where s.id = :id";
